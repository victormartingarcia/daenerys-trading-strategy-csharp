...
namespace DaenerysStrategy
{
    class DebugBacktest
    {
        static void Main(string[] args)
        {
             ...
             * 
             * Running this project will perform a Mini-Russell 6 month backtest on the Strategy, using 120 min bars.
             * 
            ...
            */
            ...
            DaenerysStrategy s = new DaenerysStrategy(new Chart(SymbolFactory.GetSymbol("TFS"), BarPeriodType.Minute, 120), null);
